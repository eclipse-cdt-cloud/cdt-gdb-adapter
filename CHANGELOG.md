...
- Fixes [`#507`](https://github.com/eclipse-cdt-cloud/cdt-gdb-adapter/pull/507): Execution of GDB commands with quotes in the Debug Console. If you have previously added inexplicable extra backslashes to commands to work around this, you need to stop doing that now.
